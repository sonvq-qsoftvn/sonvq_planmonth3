...
Route::group(['prefix' => 'admin', 'middleware' => 'auth'], function() {
    ...
    #Workoff Request
    Route::get('workoff/', 'Admin\WorkoffController@index');
    Route::get('workoff/create', 'Admin\WorkoffController@getCreate');
    Route::post('workoff/create', 'Admin\WorkoffController@postCreate');
    Route::get('workoff/{id}/edit', 'Admin\WorkoffController@getEdit');

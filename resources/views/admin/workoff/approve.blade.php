...
@section('content')
    ...
    <form id="deleteForm" class="form-horizontal" method="post" action="@if (isset($workoff)){{ URL::to('admin/workoff/' . $workoff->id . '/approve') }}@endif" autocomplete="off">
        ...
        <div class="form-group">
            <div class="controls">
               {{ Lang::get("admin/modal.delete_message") }}<br>
                ...
                <button type="submit" class="btn btn-sm btn-danger"><span class="glyphicon glyphicon-trash"></span> {{ Lang::get("admin/workoff.approve") }}</button>
            </div>
        </div>
    </form>
@stop